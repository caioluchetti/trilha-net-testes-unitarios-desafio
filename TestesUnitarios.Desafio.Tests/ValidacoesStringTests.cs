...
public class ValidacoesStringTests
{
    ...
    public void DeveContemAPalavraQualquerNoTexto()
    {
        ...
        Assert.True(resultado);  // Corrected the Assert.True based on the actual method call
    }
    ...
    public void NaoDeveConterAPalavraTesteNoTexto()
    {
        ...
        Assert.False(resultado);  // Corrected the Assert.False based on the actual method call
    }
    ...
    public void TextoDeveTerminarComAPalavraProcurado()
    {
        ...
        var textoProcurado = "procurado";  // Corrected the variable "textoProcurado"
